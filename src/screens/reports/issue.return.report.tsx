  ...
  if (loading) {
    return (
      <ReportsLayout title={t('titles.issueReturn')} subtitle={subtitle}>
        <div className="py-12 text-center text-muted">{t('loading.issueReturn')}</div>
      </ReportsLayout>
    );
  }
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-surface p-4 rounded-lg">
            ...
            <p className="text-2xl font-bold text-foreground">{formatNumber(issueReturns.length)}</p>
          </div>
          <div className="bg-surface p-4 rounded-lg">
        ...
        <div className="overflow-hidden rounded-lg border border-border">
          <h3 className="bg-surface px-6 py-3 text-sm font-semibold text-foreground">{t('labels.issueReturnDetails')}</h3>
