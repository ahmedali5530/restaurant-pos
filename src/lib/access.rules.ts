...
export const ACCESS_RULE_MODULES: Record<string, AccessRuleModule> = {
  ...
  'Inventory': {
    label: 'Inventory',
    children: ['Inventory', 'Current Inventory', 'Items', 'Suppliers', 'Item Categories', 'Stores', 'Item Groups', 'Purchase Orders', 'Purchases', 'Purchase Returns', 'Issues', 'Issue Returns', 'Wastes', 'Stock Transfers', 'Kitchen Reconciliation', 'Production Recipes', 'Production', 'Production History'] as string[]
  },
  'Settings': {
    label: 'Settings',
